    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, help_text='Required. 30 characters or fewer starting with a letter. Letters, digits', max_length=32, unique=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z][a-zA-Z0-9_\\.]+$', 'Enter a valid username starting with a-z.This value may contain only letters and numbersand underscore characters.', 'invalid')], verbose_name='username')),
                ('first_name', models.CharField(blank=True, max_length=30, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=30, verbose_name='last name')),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True, verbose_name='email address')),
                ('phone_number', models.BigIntegerField(blank=True, error_messages={'unique': 'A user with this mobile phone number already exits'}, null=True, unique=True, validators=[django.core.validators.RegexValidator('^319[0-3,9]\\d{8}$', 'Enter a valid mobile number.', 'egrwfk')], verbose_name='phone number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.NullBooleanField(help_text='femal is False, male is True, null is unset', verbose_name='gender')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(choices=[(1, 'web'), (2, 'ios'), (3, 'android')], default=3)),
